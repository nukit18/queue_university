...
from db_api.quick_cmd import get_name_and_num_win, get_description, get_ids_specialist
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        scroll_height = (len(loop.run_until_complete(get_ids_specialist())) ) * 400
        ...
        count = 0
        for e in loop.run_until_complete(get_ids_specialist()):
            num = 50 + count * 350
            count += 1
